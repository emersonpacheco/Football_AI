...
class Tracker:
    ...
    def draw_ellipse(self, frame, bbox, color, track_id=None):
        ...
        cv2.ellipse(frame, center=(x_center, y2), axes=(int(width), int(0.35*width)), angle=0, startAngle=-45,
                     endAngle=235, color=color, thickness=2,lineType=cv2.LINE_4)
        
        rectangle_witdh = 40
        rectangle_height = 20
        x1_rect = x_center - rectangle_witdh//2
        x2_rect = x_center + rectangle_witdh//2
