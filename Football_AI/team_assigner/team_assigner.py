...
class TeamAssigner:
    ...
    def get_player_color(self, frame, bbox):
        ...
        non_player_custer = max(set(corner_clusters), key=corner_clusters.count)
        player_custer = 1 - non_player_custer

        
        player_color = kmeans.cluster_centers_[player_custer]
